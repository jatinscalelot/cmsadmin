								...
								<Form className='pt-7' >
									<div className='w-full flex flex-wrap sm:flex-nowrap sm:space-x-6'>
										<div className='w-full sm:w-1/2 mb-4'>
											...
											<Field type="text" name="fname" className="input_box2 placeholder:text-[#94A3B8] placeholder:text-sm sm:placeholder:text-xl" placeholder='Enter first name' />
											<small className="text-red-500 text-base"><ErrorMessage name='fname' />
											</small>
										</div>
										<div className='w-full sm:w-1/2 mb-4'>
											<label htmlFor="" className="input-title2">Last name</label>
											<Field type="text" name="lname" className="input_box2 placeholder:text-[#94A3B8] placeholder:text-sm sm:placeholder:text-xl" placeholder='Enter last name' />
									...
									<div className='w-full flex flex-wrap sm:flex-nowrap sm:space-x-6'>
										<div className='w-full sm:w-1/2 mb-4'>
											...
											<Field type="email" name="email" className="input_box2 placeholder:text-[#94A3B8] placeholder:text-sm sm:placeholder:text-xl" placeholder='Enter email ' />
										...
										<div className='w-full sm:w-1/2 mb-4'>
											...
											<Field type="tel" name="mobile" maxLength={10} className="input_box2 placeholder:text-[#94A3B8] placeholder:text-sm sm:placeholder:text-xl" placeholder='Enter phone number' />
									...
									<div className='w-full flex flex-wrap sm:flex-nowrap sm:space-x-6'>
										...
										<div className='w-full sm:w-1/2 mb-4'>
											...
											<Field type="text" name="commission" className="input_box2 placeholder:text-[#94A3B8] placeholder:text-sm sm:placeholder:text-xl" placeholder='Enter commision' />
									...
									<div className='w-full flex flex-wrap sm:flex-nowrap sm:space-x-6'>
										<div className='w-full sm:w-1/2 mb-4'>
											...
											<Field type="password" name="password" className="input_box2 placeholder:text-[#94A3B8] placeholder:text-sm sm:placeholder:text-xl" placeholder='Enter password' />

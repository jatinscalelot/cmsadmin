                                        ...
                                        <div className='w-full flex flex-wrap md:flex-nowrap md:space-x-6 md:mb-7'>
                                            <div className="w-full flex space-x-6">
                                                ...
                                                <div className='w-full md:w-1/2 mb-3 md:mb-0'>
                                                    <label htmlFor="due_amount" className="inline-block text-sm font-bold text-yankeesBlue mb-1">Due Amount</label>
                                                    <Field type="number" name="due_amount" className="input_box placeholder:text-[#94A3B8] placeholder:text-base" placeholder='$2,000' />
                                                    <small className="text-red-500 text-xs"> <ErrorMessage name='due_amount' /></small>
                                                </div>
                                            </div>
                                        </div>
